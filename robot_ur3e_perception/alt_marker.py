...
class MarkerPublisher(Node):
    def __init__(self):
        ...
        self.cylinder_x = self.declare_parameter("cylinder_x", 0.055)
        self.cylinder_y = self.declare_parameter("cylinder_y", 0.055)
        self.cylinder_z = self.declare_parameter("cylinder_z", 0.080)
        # creating the marker
        self.marker = Marker()
